...
/*Libère intégralement la biblio CCC*/
void libere_biblio(Biblio *B);

/* Insère le morceau dont les caractéristiques sont num, titre et artiste*/
void insere(Biblio *B, int num, char *titre, char *artiste);

/*Affiche les morceaux contenus dans la Biblio CCC*/
void affiche(Biblio *B);

/*Affiche un morceau */
void afficheMorceau(CellMorceau *c);
...
/* Retourne une nouvelle biblio qui contient uniquement les morceaux de l'artiste artiste CCC*/
